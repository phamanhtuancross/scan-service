...
def scan_image_to_json_object(image_file_path):
    img_file = 'fire.jpg'
    img = cv2.imread('/Users/phamanhtuan/Desktop/me/school-project/midi-team/back-end/scan-service/SheetVision/resources/samples/races.png', 0)
    ...
    staff_recs = locate_images(img_gray, staff_imgs, staff_lower, staff_lower, staff_thresh)
